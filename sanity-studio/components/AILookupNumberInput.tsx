...
interface Props extends NumberInputProps {
  fieldKey: string   // key in the lookup response (e.g. "completionYear", "numberOfParking")
}

/**
 * Custom number input with an "✨ AI" button.
 * Calls /api/lookup-project with the project's EN name and fills this field.
 */
export function AILookupNumberInput({ fieldKey, ...props }: Props) {
  ...
  const handleChange = useCallback((value: number | undefined) => {
    props.onChange(value != null ? set(value) : unset())
  }, [props])
